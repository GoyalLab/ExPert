...
from scvi.train import DisentangledSemiSupervisedTrainingPlan, TrainRunner
...
class DISSCANVI(RNASeqMixin, VAEMixin, ArchesMixin, BaseMinifiedModeModelClass):
    ...
    _training_plan_cls = DisentangledSemiSupervisedTrainingPlan
    ...
    def __init__(
        ...
        **model_kwargs,
        ...
        group_keys = [dr for dr in self.adata_manager.data_registry if dr.startswith(REGISTRY_KEYS.GROUP_BASE_KEY)]
        n_groups = len(group_keys)
        n_labels_per_group = [self.summary_stats[f'n_{group_key}']-1 for group_key in group_keys]
        ...
        self.module = self._module_cls(
            ...
            n_groups=n_groups,
            n_labels=n_labels,
            n_labels_per_group=n_labels_per_group,
            n_batch=n_batch,
            n_hidden=n_hidden,
            n_base_latent=n_latent,
            n_layers=n_layers,
        ...
        self._model_summary_string = (
            f"Disentagled SCANVI Model with the following params: \n"
            f"n_groups: {n_groups}, n_hidden: {n_hidden}, "
    ...
    def train(
        ...
        **trainer_kwargs
        ...
        training_plan = self._training_plan_cls(self.module, self.n_labels_per_group, **plan_kwargs)
    ...
    def setup_anndata(
        ...
        **kwargs,
        ...
        # create concatenated labels key
        # TODO: move to constant
        GROUPED_LABEL_KEY = "_scvi_grouped_label"
        adata.obs[GROUPED_LABEL_KEY] = adata.obs[group_labels].agg(';'.join, axis=1)
        anndata_fields = [
            LayerField(REGISTRY_KEYS.X_KEY, layer, is_count_data=True),
            CategoricalObsField(REGISTRY_KEYS.BATCH_KEY, batch_key),
            LabelsWithUnlabeledObsField(REGISTRY_KEYS.LABELS_KEY, GROUPED_LABEL_KEY, unlabeled_category),
