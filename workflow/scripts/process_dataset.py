...
def process_dataset(dataset_link, dataset_name, output_path, cache=True, qc=True, scale=True, n_hvg=2000, subset=False):
    ...
    ds = prepare_dataset(ds, dataset_name, qc=qc, scale=True, n_hvg=n_hvg, subset=subset)
