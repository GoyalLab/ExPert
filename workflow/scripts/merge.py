...
def merge_datasets(dataset_files, hvg_files, merged_set_output, pool_output, method='harmony', hvg=True, zero_pad=True):
    ...
    merged = harmonize(dataset_files, pool, method=method, hvg=True, zero_pad=zero_pad)
